...
export interface ApiEmployeeEmployee extends Schema.CollectionType {
  ...
  attributes: {
    ...
    employed_since: Attribute.Date;
    role: Attribute.String;
    favorite_dish: Attribute.Relation<
...
export interface ApiRestaurangRestaurang extends Schema.SingleType {
  collectionName: 'restaurangs';
  info: {
    singularName: 'restaurang';
    pluralName: 'restaurangs';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::restaurang.restaurang': ApiRestaurangRestaurang;
